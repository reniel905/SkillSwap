...
public class BusinessAndFinanceAdapter extends RecyclerView.Adapter<BusinessAndFinanceAdapter.ViewHolder> {

    private ArrayList<Skill> skills = Categorizer.Business();
    ...
    @NonNull
    @Override
    public BusinessAndFinanceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BusinessAndFinanceAdapter.ViewHolder holder, int position) {
