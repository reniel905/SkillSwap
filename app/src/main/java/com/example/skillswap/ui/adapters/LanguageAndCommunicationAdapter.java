...
public class LanguageAndCommunicationAdapter extends RecyclerView.Adapter<LanguageAndCommunicationAdapter.ViewHolder> {

    private ArrayList<Skill> skills = Categorizer.Language();
    ...
    @NonNull
    @Override
    public LanguageAndCommunicationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LanguageAndCommunicationAdapter.ViewHolder holder, int position) {
