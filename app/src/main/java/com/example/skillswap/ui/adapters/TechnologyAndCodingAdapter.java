...
public class TechnologyAndCodingAdapter extends RecyclerView.Adapter<TechnologyAndCodingAdapter.ViewHolder> {

    private ArrayList<Skill> skills = Categorizer.Tech();
    ...
    @NonNull
    @Override
    public TechnologyAndCodingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TechnologyAndCodingAdapter.ViewHolder holder, int position) {
